...
<div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <form action="{{ route('post.search') }}" method="GET" class="input-group flatpickr wd-200 me-2 mb-2 mb-md-0" id="dashboardDate">
                <!-- @csrf -->
                <input type="date" name="date" class="form-control bg-transparent border-primary" data-input>
